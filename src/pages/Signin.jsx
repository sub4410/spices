        ...
        <div className="bg-white font-family-karla h-screen">
            <div className="w-full flex flex-wrap">
                ...
                <div className="w-full md:w-1/2 flex flex-col">
                    <div className="flex bg-gray-50 rounded shadow-lg mx-auto h-auto w-11/12 md:w-3/4 lg:w-3/4 flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-0 lg:px-0">
