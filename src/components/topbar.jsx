    ...
    <>
      ...
      >
              ...
              <li className="text-center md:text-left">
                <a href="#" className="block text-white py-2 md:py-0 hover:bg-gray-900 px-4">Home</a>
              </li>
              <li className="text-center md:text-left">
                <a href="#" className="block text-white py-2 md:py-0 hover:bg-gray-900 px-4">Category</a>
              </li>
              <li className="text-center md:text-left">
